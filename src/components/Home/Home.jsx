...
//     SetValues([{ ...valuse, [event.target.name]: [event.target.value] }])
//   }
//   const handleSubmit = (event) => {
//     event.preventDefault();
//     axios.post('http://localhost:4200/uploadrt', valuse)
//       .then(res => console.log("Submitted sucessfully"))
...
//                   <label htmlFor="image" className='File-upload-lable'>
//                     <h3 className="upload-your-image">Upload your image here</h3>
//                   </label>
//                   <input type="file" name='image' id='File' onChange={handleChange} className="drage-images" />
//                 </div>
...
//                   <label htmlFor="DeviceKnow">Device</label>
//                   <input type="text" name='DeviceKnow' id='Device' onChange={handleChange} className="name-input" />
